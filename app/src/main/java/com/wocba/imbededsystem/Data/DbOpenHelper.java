...
public class DbOpenHelper {
    private static final String DATABASE_NAME = "imbeded.db";
    ...
    // Insert DB
    public long insertColumn(String name, String image, String lati, String longi, String content){
        ContentValues values = new ContentValues();
        values.put(DataBases.CreateDB.NAME, name);
        values.put(DataBases.CreateDB.IMAGE, image);
        values.put(DataBases.CreateDB.LATI, lati);
        values.put(DataBases.CreateDB.LONGI, longi);
        values.put(DataBases.CreateDB.CONTENT, content);
        return mDB.insert(DataBases.CreateDB._TABLENAME, null, values);
    }

    // Update DB
    public boolean updateColumn(long id , String name, String image, String lati, String longi, String content){
        ContentValues values = new ContentValues();
        values.put(DataBases.CreateDB.NAME, name);
        values.put(DataBases.CreateDB.IMAGE, image);
        values.put(DataBases.CreateDB.LATI, lati);
